...
export default function Home() {
  ...
  const whatsappNumber = "919864072488"; // replace with real number
  const message = encodeURIComponent(
    "Urgent blood required. Please let me know if you can help."
  );
        ...
        {isSearching ? (
          ...
          <>
            ...
            <section className="mx-auto px-4 md:px-6 py-12">
              <div className="bg-primary rounded-2xl p-6 md:p-10 flex flex-col md:flex-row items-center justify-between gap-6 shadow-lg">
                {/* Left Visual */}
                ...
                <button
                  ...
                  className="flex items-center gap-3 bg-green-500 hover:bg-green-600 transition-colors text-white font-semibold px-6 py-3 rounded-xl shadow-md"
                >
                  <svg
                    className="w-6 h-6"
                    viewBox="0 0 32 32"
                    fill="currentColor"
                  >
                    <path d="M19.11 17.2c-.27-.14-1.6-.79-1.85-.88-.25-.09-.43-.14-.61.14-.18.27-.7.88-.86 1.06-.16.18-.32.2-.59.07-.27-.14-1.14-.42-2.17-1.34-.8-.71-1.34-1.6-1.5-1.87-.16-.27-.02-.42.12-.55.12-.12.27-.32.41-.48.14-.16.18-.27.27-.45.09-.18.05-.34-.02-.48-.07-.14-.61-1.48-.84-2.02-.22-.53-.44-.46-.61-.47h-.52c-.18 0-.48.07-.73.34-.25.27-.96.94-.96 2.3 0 1.36.98 2.67 1.12 2.85.14.18 1.93 2.95 4.68 4.13.65.28 1.16.45 1.55.57.65.21 1.24.18 1.7.11.52-.08 1.6-.65 1.83-1.27.23-.62.23-1.16.16-1.27-.07-.11-.25-.18-.52-.32z" />
                    <path d="M16 3C9.37 3 4 8.37 4 15c0 2.64.86 5.08 2.31 7.07L4 29l7.14-2.28A11.94 11.94 0 0016 27c6.63 0 12-5.37 12-12S22.63 3 16 3z" />
                  </svg>
                  Contact us
                </button>
              </div>
