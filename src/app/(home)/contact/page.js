        ...
        <div className="w-full mx-auto">
            ...
            <section className=" flex justify-center items-center">
                <div className="container px-4 py-12 md:py-16 lg:py-24">
                    <h1 className="text-3xl font-bold text-center mb-12">Contact Information</h1>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-0">
                        ...
                        <div className="space-y-8 flex flex-col ">
                            <div className="space-y-6">
                                ...
                                <div className="space-y-3">
                                    ...
                                    <a href="mailto:bookmydoct@gmail.com"
                                        className="flex items-center gap-2 text-primary hover:underline p-2 rounded-lg hover:bg-gray-50">
                        ...
                        <div className="flex items-start lg:items-center">
                            <form onSubmit={onSubmit} className="space-y-6 w-full max-w-[500px] mx-auto">
                                <div>
                                    <Input
                                        id="fullName"
            ...
            <section className="py-12 px-4 bg-[#F3F4F6FF] w-full text-primary text-center">
                ...
                <p className="mb-8 text-black">We'd love to hear from you! Fill in your details and let us help you connect with the right health professionals.</p>
                <Link href={'/contact'}>
                    <CustomButton className='w-[150px] mx-auto'>Get in Touch</CustomButton>
                </Link>
            </section>
        </div>
    )
