...
export default function Settings() {
    ...
    const { updateClinicDetails, getClinicDetails, clinicDetails } = useClinicAdminPanelStore();
    useEffect(() => {
        if (user) {
        ...
        <div className="p-6 space-y-8 max-w-5xl md:min-w-[600px]">
            ...
            <div className="space-y-4">
                ...
                <div className="flex flex-row gap-2 text-primary">
                    ...
                    <div className="flex flex-col">
                        ...
                        <p className="text-sm text-muted-foreground">Update Your Clinic/Hospital</p>
                    </div>
                </div>
                ...
                <div className="flex flex-col gap-y-3 md:gap-y-0 md:flex-row gap-3 justify-end">
                    ...
                    <Dialog>
                        <DialogTrigger asChild>
                            <Button variant="secondary" className="bg-rose-500 hover:bg-rose-600 text-white rounded-3xl">
                                Change Password
                            </Button>
                        </DialogTrigger>
                        <DialogContent>
                    ...
                    <Button className="rounded-3xl" onClick={handleUpdateClinic} disabled={!isClinicChanged}>
                        <Check />
                        Save Changes
                    </Button>
                </div>
            ...
            <div className="space-y-4">
                ...
                <div className="flex justify-end">
                    <Button className={`rounded-3xl`} onClick={handleUpdateAdmin} disabled={!isAdminChanged}>
                        <Check />
                        Save Changes
                    </Button>
                </div>
